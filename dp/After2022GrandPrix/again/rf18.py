...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        if self.correct_turn_direction == "right" and self.steering_angle > (
            ...
            self.steering_error = abs(self.steering_angle - self.direction_limit * 2)
    ...
    def calc_speed_reward(self):
        ...
        if self.correct_direction_angle_diff > self.direction_limit * 4:
            self.speed_reward = self.speed_reward * (
                Reward.DIRECTION_LIMIT
                / (self.correct_direction_angle_diff + Reward.DIRECTION_LIMIT)
            )
