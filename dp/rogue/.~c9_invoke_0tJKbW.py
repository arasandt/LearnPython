...
class Reward:
    ...
    def __init__(
        ...
        self.forward_direction = self.track_data[0]["angles"][DIRECTION_LOOKAHEAD * 2]
    ...
    def calc_direction_reward(self):
        ...
        if (
            ...
            self.direction_error = 1 + angle_anchor_and_heading * self.speed

        if (
            angle_anchor_and_heading_turn_direction == "right"
            and self.steering_angle <= 0
        ) or (
            angle_anchor_and_heading_turn_direction == "left"
            and self.steering_angle >= 0
        ):
            pass
        else:
