...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        if FULL_SPEED:
            ...
            revised_direction = self.get_revised_direction_scantrack(
        ...
        # if self.direction_diff > 20 and not FULL_SPEED:
        #     revised_direction = self.track_data[0]["angles"][5]
    ...
    def calc_speed_reward(self):
        ...
        limit = 25 if FULL_SPEED else 3

        if self.direction_diff > limit:
