...
def straightahead_reward_fn(
    ...
    if (
        near_direction_diff <= STEERING_THRESHOLD * 2
        and far_direction_diff <= STEERING_THRESHOLD * 2
    ):
        straight_reward = math.pow(2, speed / MAX_SPEED)
    elif far_direction_diff <= STEERING_THRESHOLD * 2:
