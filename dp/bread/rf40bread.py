...
class Reward:
    ...
    def get_revised_direction(self):
        ...
        for count in range(starting_position, DIRECTION_LOOKAHEAD * 2):
            C = self.track_data[count]["coordinates"]
            B = self.track_data[int(count // 2)]["coordinates"]
        ...
        #     ":",
        #     self.track_data[count]["waypoint"],
        #     ":",
        #     self.track_data[0]["angles"][count],
        # )
