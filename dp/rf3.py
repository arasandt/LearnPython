...
# steering_speed = steering_speed[: len(steering_speed) // 2 :]
...
def get_speed_adj_reward(row_steering, row_speed):
    ...
    if row_speed > max_speed or row_speed < min_speed:
        return 0
...
def reward_function(params):
    ...
    if params["is_offtrack"] or params["is_reversed"]:
        ...
        # For re:Invent 2019 track and Canada track, there is no need to turn right more than -10 degrees
        if steering <= -10:
            return 0.0
