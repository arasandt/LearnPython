...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        angle_check = (self.upcoming_angle / 180 + self.uturn_angle / 180) / 2
        self.direction_reward = self.direction_reward_final / math.pow(angle_check, 2)

    def calc_speed_reward(self):
        speed_check = (
            math.pow(self.upcoming_angle / 180, 2) + math.pow(self.uturn_angle / 180, 2)
        ) / 2

        self.speed_reward = speed_check * self.speed / MAX_SPEED
