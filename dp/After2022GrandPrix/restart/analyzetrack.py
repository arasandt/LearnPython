...
def get_revised_direction(current_coordinate, track_data, lookahead=20):
    angles = []
    base_angle = ""
...
for point in range(expected_track_length + 1):
    ...
    print(
        point, base_angle, revised_angle, get_direction_diff(base_angle, revised_angle)
    )
    # if point > 50:
    # break
    # break
