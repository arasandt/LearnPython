# cloning with 3.3 needed more time than 4 hours. only 45 iteration rather than required 55

# trained on final track for 2 hours, -30 steering limit and got XX.X seconds. Speed as 1 - 2.8. steering threshold 25. Direction threshhold 15
