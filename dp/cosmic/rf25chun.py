...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        self.upcoming_angle_speed = self.upcoming_angle
        self.upcoming_angle_direction = max(
            self.upcoming_angle - self.direction_diff, 0
        )
        ...
        self.direction_reward = self.direction_reward_final / math.pow(
            self.upcoming_angle_direction / 180, 1
        )

    def calc_speed_reward(self):
        self.speed_reward = (
            math.pow(self.upcoming_angle_speed / 180, 2) * self.speed / MAX_SPEED
        )
