...
class Reward:
    ...
    def calc_direction_reward(self, immediate_angle, lookahead_angle):
        ...
        self.turn_direction = Reward.get_turn_direction(
            self.immediate_angle, lookahead_angle
        )
    ...
    def calc_lane_reward(self, immediate_angle, lookahead_angle, lookbehind_angle):
        self.lane_reward = 1

        slow_direction_diff = abs(
            Reward.get_direction_diff(lookbehind_angle, lookahead_angle)
        )

        if slow_direction_diff <= 90 and not self.fast_lane:
...
def reward_function(params):
    ...
    #     rewards = 0
        ...
        reward.calc_direction_reward(immediate_angle, all_angles[-1])
        ...
        reward.calc_lane_reward(immediate_angle, all_angles[-1], lookbehind_angle)
