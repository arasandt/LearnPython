    ...
    if not is_left:
        if turn_direction == "right" and direction_diff >= STEERING_THRESHOLD * 3:
            ...
            if not all_wheels_on_track:
                edge_reward += 0.4
        elif turn_direction == "left" and direction_diff > STEERING_THRESHOLD * 5:
            edge_reward = -direction_diff / (direction_diff + STEERING_THRESHOLD * 5)
        else:
            edge_reward += border_reward
            if not all_wheels_on_track:
                edge_reward += 0.4
