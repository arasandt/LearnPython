...
#   "lr": 0.0003,
#   "num_episodes_between_training": 90,
#   "num_epochs": 4,
#   "stack_size": 1,
#   "term_cond_avg_score": 100000.0,
#   "term_cond_max_episodes": 10000
# }
# Action space from file: {'speed': {'high': 2.0, 'low': 1.2}, 'steering_angle': {'high': 30, 'low': -30}}

import math, time

MAX_STEERING = 30
MIN_SPEED, MAX_SPEED = 1.2, 4.0
...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        # )
        self.correct_turn_direction = self.get_turn_direction(
            get_angle_between_coordinates(
                self.heading_coordinates["xy"], self.track_data[0]["coordinates"]
            ),
            revised_direction,
        )
