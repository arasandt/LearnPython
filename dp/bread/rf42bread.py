...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        if self.turn_direction == "right" and self.steering_angle < 0:
            self.correct_direction_angle_diff -= self.steering
        if self.turn_direction == "left" and self.steering_angle > 0:
            self.correct_direction_angle_diff -= self.steering

        self.correct_direction_angle_diff = abs(self.correct_direction_angle_diff)

        self.direction_error = 1 - self.correct_direction_angle_diff / 30
