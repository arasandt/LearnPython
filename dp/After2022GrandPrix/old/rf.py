...
class Reward:
    ...
    def calc_speed_reward(self, immediate_angle, lookahead_angle):
        ...
        if (
            ...
            # 2.33 is good till 3.0 MAX SPEED
            slow_speed = (MAX_SPEED + MIN_SPEED) / 2.33
            self.speed_reward = slow_speed / (slow_speed + self.speed)

            self.calc_steering_reward(1)
