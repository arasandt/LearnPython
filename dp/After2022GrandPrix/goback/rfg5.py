...
class Reward:
    ...
    def get_revised_direction(self, current_coordinate, lookahead=20, limit=20):
    ...
    def calc_speed_reward(self):
        ...
        if self.direction_diff > 10:
            # cut down the speed reward based on how much direction diff it is
            self.speed_reward = (
                self.speed_reward * MAX_STEERING / (self.direction_diff + MAX_STEERING)
            )
