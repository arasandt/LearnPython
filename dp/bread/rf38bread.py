...
class Reward:
    ...
    def __init__(
        ...
        #     self.track_data[DIRECTION_LOOKAHEAD]["coordinates"],
        # )
        self.revised_direction = self.track_data[DIRECTION_LOOKAHEAD]["angles"][
            DIRECTION_LOOKAHEAD
        ]
    ...
    def calc_direction_reward(self):
        ...
        self.direction_reward = math.pow(self.direction_reward, 1)
    ...
    def calc_speed_reward(self):
        self.speed_reward = math.pow(self.direction_reward, 1) * self.speed / MAX_SPEED
