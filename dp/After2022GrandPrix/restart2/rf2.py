...
class Reward:
    ...
    def __init__(
        ...
        self.uturn = False
        if int(self.track_data["uturn"]) < UTURN_THRESHOLD_DEGREE:
            self.uturn = True
    ...
    def calc_direction_reward(self):
        ...
        if self.correct_turn_direction == "right" and self.steering_angle > (
            wrong_steering_limit
        ):
            steering_error = abs(self.steering_angle - wrong_steering_limit)
    ...
    def calc_lane_reward(self):
        ...
        #     if (self.correct_turn_direction == "left" and not self.is_left) or (
        #         self.correct_turn_direction == "right" and self.is_left
        #     ):
        #         self.lane_reward = 1
        #     else:
        #         self.off_track = True
