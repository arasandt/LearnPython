...
def speed_reward_fn(
    ...
    slight_lane_1 = list(range(28, 29 + 1))
    slight_lane_2 = list(range(39, 40 + 1))
    uturn_lane_4 = list(range(63, 64 + 1))
    slight_lane_3 = list(range(73, 73 + 1))
    ...
    if closest_waypoints[1] in uturn_lane_1:
    ...
    elif closest_waypoints[1] in slight_lane_1 + slight_lane_2:
        ...
        if speed <= max(MAX_SPEED * 0.55, MIN_SPEED):
            ...
            speed_reward = MAX_SPEED / (speed + MAX_SPEED)
    elif closest_waypoints[1] in slight_lane_3:
...
def edge_reward_fn(
    ...
    left_lane_2 = list(range(20, 25 + 1))
    # mid_lane_4 = list(range(26, 26 + 1))
    right_lane_3 = list(range(28, 29 + 1))
    left_lane_3 = list(range(32, 34 + 1))
    right_lane_4 = list(range(39, 40 + 1))
    left_lane_5 = list(range(45, 46 + 1))
    right_lane_5 = list(range(49, 61 + 1))
    left_lane_6 = list(range(67, 71 + 1))
    ...
    elif closest_waypoints[1] in left_lane_2 + left_lane_3 + left_lane_5 + left_lane_6:
        if is_left:
