...
class Track:
    ...
    def get_track_data(self):
        ...
        track_data["uturnahead"] = get_direction_diff(
            track_data[0]["angles"][5],
...
class Reward:
    ...
    def __init__(
        ...
        self.uturnahead = False
        self.uturnahead_angle = int(self.track_data["uturnahead"])
        if self.uturnahead_angle < UTURN_THRESHOLD_DEGREE:
            self.uturnahead = True
