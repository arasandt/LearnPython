...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        if self.correct_turn_direction == "right" and self.steering_angle > (
            ...
            self.steering_error = abs(self.steering_angle - direction_limit * 2)
        ...
        self.direction_reward = Reward.DIRECTION_LIMIT / (
            Reward.DIRECTION_LIMIT + self.correct_direction_angle_diff + self.steering_error
        )
    ...
    def calc_speed_reward(self):
        ...
        # cut down the speed reward based on how much steering it is.
        self.speed_reward = speed_reward * (
            Reward.DIRECTION_LIMIT / (self.correct_direction_angle_diff + self.steering_error + Reward.DIRECTION_LIMIT)
        )
