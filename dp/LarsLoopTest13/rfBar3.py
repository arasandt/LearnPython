...
def straightahead_reward_fn(
    reward, immediate_direction, lookahead_direction, lookwayahead_direction, speed
):
    ...
    if (
        near_direction_diff <= STEERING_THRESHOLD
        and far_direction_diff <= STEERING_THRESHOLD
    ):
        straight_reward = math.pow(2, speed / MAX_SPEED)
    elif far_direction_diff <= STEERING_THRESHOLD:
