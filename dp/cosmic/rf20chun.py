...
class Reward:
    ...
    def get_revised_direction(self):
        ...
        ten_coordinate = self.track_data[C_position]["coordinates"]
        upcoming_angle = get_upcoming_angle(
            current_coordinate, five_coordinate, ten_coordinate
        )
        return revised_direction, upcoming_angle
    ...
    def __init__(
        ...
        self.revised_direction, self.upcoming_angle = self.get_revised_direction()
    ...
    def calc_speed_reward(self):
        ...
        self.speed_reward = math.pow(self.upcoming_angle / 180, 2) * speed_reward
