...
class Reward:
    ...
    def calc_direction_reward(self):
        ...
        # acceptable_diff = (180 - self.current_angle) + (180 - self.upcoming_angle)
        # acceptable_diff = acceptable_diff / 45

        # self.correct_direction_angle_diff = min(
        #     0, self.correct_direction_angle_diff - acceptable_diff
        # )
    ...
    def calc_speed_reward(self):
        ...
        # direction_factor = 2 + (1 - direction_weight / 2)
        # OR 2 for high speed action space. changed to 1 for slow speed.
        direction_factor = 2
        self.speed_reward = (
            math.pow(self.direction_error_four, direction_factor)
            * self.speed
            / MAX_SPEED
        )
